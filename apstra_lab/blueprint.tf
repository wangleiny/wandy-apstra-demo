...
locals {
  switches = {
    spine1                  = "525400584AEC" // <ip_prefix>.11
    spine2                  = "52540034C63E" // <ip_prefix>.12
    apstra_esi_001_leaf1    = "525400658B4D" // <ip_prefix>.13
    apstra_esi_001_leaf2    = "525400738CEC" // <ip_prefix>.15
    apstra_single_001_leaf1 = "525400B4E165" // <ip_prefix>.14
  }
}
